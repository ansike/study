...
(function (global, factory) {
  ...
  var emptyObject = Object.freeze({});//创建一个冻结对象

  // these helpers produces better vm code in JS engines due to their
  // explicitness 明确性 and function inlining 内联
  function isUndef(v) { //判断是否是undefined  undefined||null-->true
    return v === undefined || v === null
  }

  function isDef(v) { //判断是否是undefined    undefined||null-->false
    return v !== undefined && v !== null
  }
  ...
  /**
   * Check if value is primitive原生的
   */
